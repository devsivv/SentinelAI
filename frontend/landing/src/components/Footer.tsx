...
export default function Footer() {
  return (
    <footer className="border-t border-blue-900/30 bg-[#080E1A] text-gray-400 py-16 px-4 sm:px-6 lg:px-8 relative" role="contentinfo">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-gray-800">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href={CITIZEN_URL} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                  Citizen Portal
                </a>
              </li>
              <li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1.5 text-xs text-gray-400">
              ...
              <li>PyTorch, XGBoost & SHAP</li>
              <li>PostgreSQL & Alembic</li>
              <li>Render & Vercel</li>
            </ul>
          </div>
        </div>
