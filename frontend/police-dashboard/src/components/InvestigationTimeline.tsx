...
export default function InvestigationTimeline({ timeline }: InvestigationTimelineProps) {
  return (
    <div className="bg-white shadow-sm ring-1 ring-black ring-opacity-5 rounded-lg p-4 sm:p-6 h-full">
      <div className="flex items-center gap-2 mb-5 border-b border-gray-200 pb-4">
        <Clock className="h-5 w-5 text-gray-400 shrink-0" aria-hidden="true" />
      ...
      {timeline.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <p className="text-xs text-gray-500">Investigation timeline events will appear here.</p>
        </div>
      ) : (
              ...
              <li key={eventItem.id}>
                <div className="relative pb-8">
                  ...
                  <div className="relative flex items-start gap-3 sm:gap-4">
                    ...
                    <div className="flex flex-col gap-0.5 min-w-0 flex-1 pt-1.5">
