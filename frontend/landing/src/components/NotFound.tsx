  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3">
        <Link
          to="/"
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-500 px-6 py-3 text-sm font-bold text-white shadow-lg shadow-blue-900/40 transition-all min-h-[44px] w-full sm:w-auto"
        >
          <ArrowLeft className="h-4 w-4" aria-hidden="true" />
          <span>Return to SentinelAI Home</span>
        </Link>
      </div>
    </div>
  );
